...
theme_opts<-list(theme(panel.grid.minor = element_blank(),
                       ...
                       panel.background = element_rect(fill = 'dark grey', colour = NA),
                       plot.background = element_rect(fill="dark grey", size=1,linetype="solid",color="black"),
                       ...
                       legend.background = element_rect(fill="dark grey", size=1,linetype="solid",color="dark grey"),
                       legend.key = element_rect(fill = 'dark grey',color = 'dark grey'),
                       legend.key.width = unit(3, 'lines'),
                       legend.position = "bottom"))

basemap <-   ggplot(data_csd) +
    geom_polygon(aes(long, lat, group = group), fill = "black", size=0.1, color = 'grey') +
...
our basemap.
```{r, fig.height=13, fig.width=13, message=TRUE, warning=TRUE}
# 1 dot = 5 immigrants
scale=5
